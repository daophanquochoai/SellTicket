package doctorhoai.learn.rateservice.exception;

import doctorhoai.learn.rateservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler( value = {FilmNotFound.class, CustomerNotFound.class, RateNotFound.class})
