                    ...
                    <nav>
                        <ul className={'flex gap-9'}>
                            <li className={'group cursor-pointer'}>
                                <div>
                                    <p className={'tet-[32px] text-white group-hover:text-main transition-all duration-300 font-bold'} onClick={() => handleToHome()}>Trang Chủ</p>
                                    <div
                                        className={'h-[1px] w-0 group-hover:w-full transition-all duration-200 bg-main'}></div>
                                </div>
                            </li>
                            <li className={'group cursor-pointer'}>
                                <p className={'tet-[32px] text-white group-hover:text-main transition-all duration-300 font-bold'}>Rạp Chiếu Phim</p>
                                <div
                                    className={'h-[1px] w-0 group-hover:w-full transition-all duration-200 bg-main'}></div>
                            </li>
                        </ul>
                    ...
                    <div className="py-2">
                        {
                            isLogin ? (
                                <>
                                    <div className="flex items-center justify-center gap-2" onClick={() => setPropUp(true)}>
                                        <img
                                ...
                                <>
                                    <div className={'flex gap-4 items-center'}>
                                        ...
                                        <div className="relative flex justify-center overflow-hidden bg-main group w-[100px] rounded-xl border-2 border-main text-main cursor-pointer" onClick={()=> handleSignUp()}>
                                            <span className="absolute inset-0 w-full h-full bg-white -left-full transition-all duration-500 ease-in-out group-hover:left-0 "></span>
